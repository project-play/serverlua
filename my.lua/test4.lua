    ...
    if senderID then
        ...
        if monitor then
            ...
            for i, zug in ipairs(sortedZuege) do
                ...
                -- Debugging: Überprüfen, ob alle Variablen korrekt gesetzt sind
                if not zug.linie or not zug.ziel or not abfahrtText or not zug.bahnsteig then
                    print("Fehler: Eine der Zuginformationen ist nil:")
                    print("Linie: ", zug.linie)
                    print("Ziel: ", zug.ziel)
                    print("Abfahrt: ", abfahrtText)
                    print("Steig: ", zug.bahnsteig)
                end

                -- Formatierte Zeile ohne Klammern
                local lineText = string.format("Linie %s, Ziel: %s, Abfahrt: %s, Steig: %d", zug.linie, zug.ziel, abfahrtText, zug.bahnsteig)
            ...
            -- Setze den Cursor auf die 3. Zeile
